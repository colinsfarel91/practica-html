    ...
    <div class="bend-content-wrap">
      <div class="smile-settings-wrapper">
        <h2 class="nav-tab-wrapper">
            ...
            <!-- <a class="nav-tab" href="?page=<?php echo CP_PLUS_SLUG;?>&view=cp_import" title="<?php _e( "Import", "smile" ); ?>"><?php echo __( "Import", "smile" ); ?></a> -->

            <a class="nav-tab nav-tab-active" href="?page=<?php echo CP_PLUS_SLUG;?>&view=registration" title="<?php _e( "Registration", "smile"); ?>"><?php echo __("Registration", "smile" ); ?></a>
      ...
      <div class="container cp-welcome-bottom-content">
        ...
        <?php
        if ( is_multisite() ) {
          $redirect_url= network_admin_url()."index.php?page=bsf-registration";
        }else{
          $redirect_url=  get_admin_url()."index.php?page=bsf-registration";
        }
        ?>
          <a rel="noopener" target="_blank" class="button-primary cp-welcome-started" href="<?php echo $redirect_url;?>"><?php _e( "LET'S GET STARTED", "smile" ); ?></a>
        </div>
